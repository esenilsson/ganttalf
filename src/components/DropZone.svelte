...
{:else}
  <div
    role="button"
    tabindex="0"
    class="flex w-full flex-col items-center justify-center gap-4 rounded-xl border-2 border-dashed bg-gt-paper p-10 text-center transition-colors duration-[120ms] ease-out {dragOver ? 'border-gt-brick-500 bg-gt-line-soft' : 'border-gt-ink-faint/50'}"
